...
import { EllipsisVerticalIcon, PencilSquareIcon, TrashIcon } from "@heroicons/vue/20/solid";
            ...
            <MenuItems class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div class="py-1">
                    <MenuItem v-slot="{ active }">
                        <Link :href="route('tasks.edit', task.id)" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'group flex items-center px-4 py-2 text-sm']">
                    ...
                    <MenuItem v-slot="{ active }">
                        <button @click="deleteTask" :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'group w-full flex items-center px-4 py-2 text-sm']">
